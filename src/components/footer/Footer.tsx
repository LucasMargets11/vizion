  ...
  <footer className="w-full bg-black text-white py-16 text-sm">
    <div className="w-full px-6 md:px-12 lg:px-20 flex flex-col md:flex-row justify-between gap-12">
      <div className="space-y-4 max-w-sm">
        <a href="#top" className="font-outfit text-2xl font-extrabold tracking-tight">Lumiax</a>
      ...
      <div className="space-y-4">
        <p className="text-white/60">&copy; {new Date().getFullYear()} Lumiax. Todos los derechos reservados.</p>
